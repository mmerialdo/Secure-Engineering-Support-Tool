...
(
	...
	`USERNAME` varchar(20) NULL UNIQUE COLLATE 'latin1_bin',
...
CREATE TRIGGER `DELETE_SESTUSER`
AFTER DELETE ON SESTUSER FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_SYSPARTICIPANT`
AFTER DELETE ON SYSPARTICIPANT FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

DELIMITER //
CREATE TRIGGER `DELETE_ASSPROCEDURE`
AFTER DELETE ON ASSPROCEDURE FOR EACH ROW
BEGIN
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;
DELETE FROM ASSET_MODEL WHERE ID = OLD.ASSET_ID;
DELETE FROM THREAT_MODEL WHERE ID = OLD.THREAT_ID;
DELETE FROM VULNERABILITY_MODEL WHERE ID = OLD.VULNERABILITY_ID;
DELETE FROM SAFEGUARD_MODEL WHERE ID = OLD.SAFEGUARD_ID;
DELETE FROM RISK_MODEL WHERE ID = OLD.RISKMODEL_ID;
DELETE FROM RISKTREATMENT_MODEL WHERE ID = OLD.RISKTREATMENTMODEL_ID;
END; //
DELIMITER ;


CREATE TRIGGER `DELETE_ASSTEMPLATE`
AFTER DELETE ON ASSTEMPLATE FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_ASSPROFILE`
AFTER DELETE ON ASSPROFILE FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

DELIMITER //
CREATE TRIGGER `DELETE_ASSPROJECT`
AFTER DELETE ON ASSPROJECT FOR EACH ROW
BEGIN
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;
DELETE FROM SYSPROJECT WHERE ID = OLD.SYSPROJECT_ID;
END; //
DELIMITER ;

CREATE TRIGGER `DELETE_ASSAUDIT`
AFTER DELETE ON ASSAUDIT FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_VULNERABILITY_REFERENCE`
AFTER DELETE ON VULNERABILITY_REFERENCE FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_ASSET_MODEL`
AFTER DELETE ON ASSET_MODEL FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_VULNERABILITY_MODEL`
AFTER DELETE ON VULNERABILITY_MODEL FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_RISK_MODEL`
AFTER DELETE ON RISK_MODEL FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_THREAT_MODEL`
AFTER DELETE ON THREAT_MODEL FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_SAFEGUARD_MODEL`
AFTER DELETE ON SAFEGUARD_MODEL FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_THREAT_REFERENCE`
AFTER DELETE ON THREAT_REFERENCE FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;

CREATE TRIGGER `DELETE_RISKTREATMENT_MODEL`
AFTER DELETE ON RISKTREATMENT_MODEL FOR EACH ROW
DELETE FROM SESTOBJ WHERE IDENTIFIER = OLD.SESTOBJ_ID;
