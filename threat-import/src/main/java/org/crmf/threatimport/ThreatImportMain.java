/* --------------------------------------------------------------------------------------------------------------------
// Copyright file="ThreatImportMain.java"
...
public class ThreatImportMain {

	private static final Logger LOG = LoggerFactory.getLogger(ThreatImportMain.class.getName());
