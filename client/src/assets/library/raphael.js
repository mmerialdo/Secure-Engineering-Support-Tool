...
(function (glob, factory) {
    ...
    elproto.animateWith = function (el, anim, params, ms, easing, callback) {
        ...
        //     lockedBy = element.lockedBy(anim);
        // return this.animate(a).lockedBy(a, lockedBy * anim.ms / a.ms);
    };
     ...
     * Element.setTime
     [ method ]
     **
     * Sets the lockedBy of animation of the element in milliseconds. Similar to @Element.lockedBy method.
     **
     > Parameters
     **
     ...
     * Element.lockedBy
     [ method ]
     **
     * Gets or sets the lockedBy of animation of the element.
     **
     > Parameters
     **
     - anim (object) #optional animation object
     - value (number) #optional 0 – 1. If specified, method works like a setter and sets the lockedBy of a given animation to the value. This will cause animation to jump to the given position.
     **
     = (number) lockedBy
     * or
     = (array) lockedBy if `anim` is not specified. Array of objects in format:
     o {
     o     anim: (object) animation object
     o     lockedBy: (number) lockedBy
     o }
     * or
     = (object) original element if `value` is specified
     \*/
